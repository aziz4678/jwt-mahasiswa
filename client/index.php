...
<legend>Tambah Data</legend>	
	...
	<form class="form-horizontal" name="form1" method="POST" action="proses.php" novalidate>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="alamat" class="input-medium" placeholder="Alamat Mahasiswa"
					rel="tooltip" data-placement="right" title="Masukkan Alamat Mahasiswa"
					required data-validation-required-message="Harus diisi">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="email" class="input-medium" placeholder="E-mail Mahasiswa"
					rel="tooltip" data-placement="right" title="Masukkan E-mail Mahasiswa"
					required data-validation-required-message="Harus diisi">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="nohp" class="input-medium" placeholder="No. HP Mahasiswa"
					rel="tooltip" data-placement="right" title="Masukkan No. HP Mahasiswa"
					required data-validation-required-message="Harus diisi">
			</div>
		</div>
		<div class="control-group">
...
<legend>Ubah Data</legend>	
	<form name="form1" method="post" action="proses.php" class="form-inline">
		...
		<input type="text" name="email" class="input-medium" placeholder="E-mail Mahasiswa" value="<?=$r->email?>">
		<input type="text" name="nohp" class="input-medium" placeholder="No. HP Mahasiswa" value="<?=$r->nohp?>">
