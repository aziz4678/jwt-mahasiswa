...
{	private $host="localhost";	
	...
	*/
	...
	{	// query ke lokal database client
		...
		foreach ($data as $r)	
		{	// query ke lokal database client
			$query = $this->conn->prepare("insert into mahasiswa (nim,nama,alamat,email,nohp) values (?,?,?,?,?)");	
			$query->execute(array($r->nim,$r->nama,$r->alamat,$r->email,$r->nohp));	
...
$url = 'http://192.168.56.136/jwt-mahasiswa/server/server.php';
